...
echo "fee", press up-arrow and replace "fee" with "fie" and repeat
...
To eat the world’s due, by the grave and thee.” >  sonnet_1_complete.txt
...
Q: Use the command curl -I www.learnenough.com to fetch the HTTP header for the Learn Enough website. What is the HTTP status code of the address? How does this differ from the status code of 
...
press spacebar 3 times to go down 3 pages
